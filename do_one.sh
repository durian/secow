...
TRAIN="SECOW2012-00XS_TEXT.out.txt.1e6"
...
#
PF="00"                #index number in filename (pos filtered)
IE="000"               #index number in filename (instance errors)
CFSET="cf_enett.txt"
...
CC="000"               #index number in filename
